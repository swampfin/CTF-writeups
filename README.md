# CTF-writeups
Welcome to my write-up repository! Here, I document my try to solve Capture The Flag (CTF) challenges. I will be happy if this repository is useful to you. 

Disclaimer! Here I publish my methods for solving CTF, while simultaneously improving my technical skills. Frankly, for this reason, the reports themselves can be poorly.
<br><br>
### **Network Forensics** 🦭
